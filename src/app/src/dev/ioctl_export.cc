...
IOCTL_ENUM_IOCTL("ARA_TESTER_SET_DIRECTION", ARA_TESTER_SET_DIRECTION);
IOCTL_ENUM_IOCTL("ARA_TESTER_SET_EVEN", ARA_TESTER_SET_EVEN);
IOCTL_ENUM_IOCTL("ARA_TESTER_SET_PROGRESSIVE", ARA_TESTER_SET_PROGRESSIVE);
IOCTL_ENUM_IOCTL("ARA_TESTER_SET_PULSE_WIDTH", ARA_TESTER_SET_PULSE_WIDTH);
