...
NAN_METHOD(UlongIoctl) {
    Nan::HandleScope scope;
    v8::Local<v8::Object> return_value = Nan::New<v8::Object>();
    long ioctl_return;
    unsigned long argument = 0;
    if(!info[0]->IsInt32()) {
        Nan::ThrowTypeError("Argument 0 Must be an Integer (valid file discriptor)");
    }
    if (!info[1]->IsUint32()) {
        Nan::ThrowTypeError("Argument 1 Must be an Integer (uint32_t) (valid ioct)");
    }
...
void InitAll(v8::Local<v8::Object> exports, v8::Local<v8::Object> module) {
    Nan::SetMethod(module, "exports", UlongIoctl);
}
