...
#define ARA_TESTER_SET_PROGRESSIVE _ARA_TESTER_DEFINE_IOCTL(W, 3)
#define ARA_TESTER_SET_LINEAR _ARA_TESTER_DEFINE_IOCTL(W, 4)

#define ARA_TESTER_SET_PULSE_WIDTH _ARA_TESTER_DEFINE_IOCTL(W, 5)
#define ARA_TESTER_SET_T_MAX _ARA_TESTER_DEFINE_IOCTL(W, 6)
#define ARA_TESTER_SET_T_MIN _ARA_TESTER_DEFINE_IOCTL(W, 7)
#define ARA_TESTER_SET_T_DELTA _ARA_TESTER_DEFINE_IOCTL(W, 8)

#define ARA_TESTER_GET_ACTIVE _ARA_TESTER_DEFINE_IOCTL(R, 9)
...
#define ARA_TESTER_LAST_IOCTL 11
